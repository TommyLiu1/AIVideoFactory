...
class LoginFrame(wx.Frame):
    ...
    def create_widgets(self):
        ...
        self.username_text = wx.TextCtrl(self.panel, size=(300, 40), style=wx.BORDER_NONE | wx.TEXT_ALIGNMENT_CENTER)
        ...
        self.password_text = wx.TextCtrl(self.panel, size=(300, 40), style=wx.TE_PASSWORD | wx.BORDER_NONE)
        ...
        # Login Button
        login_button = wx.Button(self.panel, label="登录", size=(250, 50))
    ...
    def on_login(self, event):
        ...
        try:
            ...
            wx.MessageBox(f"数据库查询错误: {e}", "错误", wx.OK | wx.ICON_ERROR)
        finally:
            session.close()